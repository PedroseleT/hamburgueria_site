...
import { Package, Calendar, Clock, ChevronRight, Flame, CheckCircle2, ChefHat, Bike, XCircle } from "lucide-react";
            ...
            <div className="flex flex-col items-center gap-1">
              <div
                style={{
                  width: 28, height: 28,
                  borderRadius: "50%",
                  border: active ? `2px solid ${cfg.color}` : "2px solid #2a2a2a",
                  background: active ? `${cfg.color}22` : "#111",
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLDivElement).style.boxShadow = `0 25px 70px rgba(0,0,0,0.7), 0 0 0 1px ${cfg.color}22`;
      }}
      onMouseLeave={e => {
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: "#444", letterSpacing: "0.15em" }}>
        ...
        <div style={{
          ...
          <span style={{ color: cfg.color, fontSize: 10, fontWeight: 800, letterSpacing: "0.15em", textTransform: "uppercase" }}>
            {cfg.label}
          </span>
        </div>
      </div>
          ...
          {(expanded ? order.items : order.items.slice(0, 2)).map((item) => (
            <div key={item.id} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ color: "#ccc", fontSize: 13, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ color: "#3a3a3a", fontSize: 9, fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 2 }}>
            Total
          </div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
            <span style={{ color: "#b91c1c", fontSize: 12, fontWeight: 800 }}>R$</span>
            <span style={{ color: "#fff", fontSize: 26, fontWeight: 900, letterSpacing: "-0.02em", fontStyle: "italic" }}>
    ...
    <>
      <style>{`
        ...
        @keyframes flamePulse {
          0%, 100% { text-shadow: 0 0 20px #b91c1c88; }
          50% { text-shadow: 0 0 40px #b91c1ccc, 0 0 80px #b91c1c44; }
        }
      `}</style>
        ...
        <main style={{
          ...
          <header style={{ marginBottom: 48, position: "relative", paddingLeft: 20 }}>
            <div style={{
              ...
              width: 3, height: "80%",
              background: "linear-gradient(180deg, #b91c1c, transparent)",
          ...
          {loading ? (
            ...
            <div style={{
              ...
              <p style={{ color: "#333", fontSize: 12, fontWeight: 700, letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: 32 }}>
                Nenhum pedido encontrado na brasa.
              </p>
              <Link
                href="/cardapio"
                style={{
